...
/**
  ...
  */
class ChatConnectionObservableProxySpec extends TestKit(ActorSystem("ChatConnectionObservableProxySpec")) with Matchers with WordSpecLike with MockitoSugar with MoreMockitoSugar {
  ...
  "ChatConnectionObservableProxy" should {
    "start" in {
      ...
      val proxy = system.actorOf(Props[ChatConnectionObservableProxy])
