...
public class ChannelModeNotification implements ChannelNotification {
    ...
    public ChannelModeNotification(ServerDesc serverDesc, LocalDate time, String channel, ChatUser user, List<Character> addedModes, List<Character> removedModes) {
